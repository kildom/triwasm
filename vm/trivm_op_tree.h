      ...
      if (op & 1 << 4) {                                                                                          \
        ...
        if (op & 1 << 3) {                                                                                        \
          if (op & 1 << 2) {                                                                                      \
              ...
              /* SDIV 0xA */ arg1 = check_sdiv(vm, arg0, arg1); ret = (uint32_t)((int32_t)arg0 / (int32_t)arg1);  \
          }                                                                                                       \
        } else {                                                                                                  \
          if (op & 1 << 2) {                                                                                      \
              /* UMOD 0x9 */ ret = arg0 % arg1;                                                                   \
          } else {                                                                                                \
...
#define TRIVM_OP_CODE_UMOD64 0x5
#define TRIVM_OP_CODE_SDIV64 0x6
