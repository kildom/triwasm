...
enum InstrOpcode {
    ...
    INSTR_TRIVM_CALL_IMPORT = 0x7FFFFF01,
    INSTR_TRIVM_EXTS = 0x7FFFFF02,
    INSTR_TRIVM_EXTS64 = 0x7FFFFF03,
    INSTR_TRIVM_POP = 0x7FFFFF04,
    INSTR_TRIVM_DUP = 0x7FFFFF05,
    INSTR_TRIVM_FUNCTION = 0x7FFFFF06,
    INSTR_TRIVM_FBR = 0x7FFFFF07,
    INSTR_TRIVM_BBR = 0x7FFFFF08,
    INSTR_TRIVM_FBR_IF = 0x7FFFFF09,
    INSTR_TRIVM_BBR_IF = 0x7FFFFF0A,
    INSTR_TRIVM_RETURN_IF = 0x7FFFFF0B,
