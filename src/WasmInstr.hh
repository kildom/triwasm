...
enum InstrOpcode {
    ...
    INSTR_RETURN_CALL = 0x12,
    INSTR_RETURN_CALL_INDIRECT = 0x13,
    INSTR_DROP = 0x1A,
    INSTR_SELECT = 0x1B,
    INSTR_SELECT_T = 0x1C,
    ...
    INSTR_TRIVM_EMPTY = 0x7FFFFF00,
    INSTR_TRIVM_POP = 0x7FFFFF01,
    INSTR_TRIVM_EXTS = 0x7FFFFF02,
    INSTR_TRIVM_SHL64WL = 0x7FFFFF03,
    INSTR_TRIVM_EXTS64LL = 0x7FFFFF04,
    INSTR_TRIVM_LOW64WL = 0x7FFFFF05,
    INSTR_TRIVM_I32_READ_STACK = 0x7FFFFF06,
    INSTR_TRIVM_I64_READ_STACK = 0x7FFFFF07,
    INSTR_TRIVM_I32_LOCAL_GET = 0x7FFFFF08,
    INSTR_TRIVM_I64_LOCAL_GET = 0x7FFFFF09,
    INSTR_TRIVM_I32_LOCAL_SET = 0x7FFFFF0A,
    INSTR_TRIVM_I64_LOCAL_SET = 0x7FFFFF0B,
    INSTR_TRIVM_I32_GLOBAL_GET = 0x7FFFFF0C,
    INSTR_TRIVM_I64_GLOBAL_GET = 0x7FFFFF0D,
    INSTR_TRIVM_I32_GLOBAL_SET = 0x7FFFFF0E,
    INSTR_TRIVM_I64_GLOBAL_SET = 0x7FFFFF0F,
    INSTR_TRIVM_FUNCTION = 0x7FFFFF10,
