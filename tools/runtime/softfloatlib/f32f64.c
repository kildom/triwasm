...
TRIVM_INLINE_ASSEMBLY(
    "MUL 2\n"
    "READ16U [POP] + $_ProgramMemBase + softfloat_approxRecipSqrt_1k0s_table\n")
uint16_t softfloat_approxRecipSqrt_1k0s_asm(int index);

TRIVM_INLINE_ASSEMBLY(
    "MUL 2\n"
    "READ16U [POP] + $_ProgramMemBase + softfloat_approxRecipSqrt_1k1s_table\n")
uint16_t softfloat_approxRecipSqrt_1k1s_asm(int index);

TRIVM_INLINE_ASSEMBLY(
    "MUL 2\n"
    "READ16U [POP] + $_ProgramMemBase + softfloat_approxRecip_1k0s_table\n")
uint16_t softfloat_approxRecip_1k0s_asm(int index);

TRIVM_INLINE_ASSEMBLY(
    "MUL 2\n"
    "READ16U [POP] + $_ProgramMemBase + softfloat_approxRecip_1k1s_table\n")
