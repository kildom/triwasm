...
const simpleGenerators: { [key: number]: string | ((instr: any) => string); } = {
    ...
    [OP.NOP]: '# NOP',
    [OP.I32_LOAD]: (instr: OpType.I32_LOAD) => `READ32 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I64_LOAD]: (instr: OpType.I64_LOAD) => `READ64 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD8_S]: (instr: OpType.I32_LOAD8_S) => `READ8S [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD8_U]: (instr: OpType.I32_LOAD8_U) => `READ8U [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD16_S]: (instr: OpType.I32_LOAD16_S) => `READ16S [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD16_U]: (instr: OpType.I32_LOAD16_U) => `READ16U [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_STORE]: (instr: OpType.I32_STORE) => `WRITE32 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I64_STORE]: (instr: OpType.I64_STORE) => `WRITE64 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_STORE8]: (instr: OpType.I32_STORE8) => `WRITE8 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_STORE16]: (instr: OpType.I32_STORE16) => `WRITE16 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_EQZ]: 'NOT',
    [OP.I32_EQ]: 'EQ',
    [OP.I32_LT_S]: 'SLT',
    [OP.I32_LT_U]: 'ULT',
