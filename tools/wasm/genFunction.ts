...
const simpleGenerators: { [key: number]: string | ((instr: any) => string); } = {
    ...
    [OP.NOP]: '# NOP',
    [OP.I32_LOAD]: (instr: OpType.I32_LOAD) => `UREAD32 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I64_LOAD]: (instr: OpType.I64_LOAD) => `UREAD64 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD8_S]: (instr: OpType.I32_LOAD8_S) => `UREAD8S [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD8_U]: (instr: OpType.I32_LOAD8_U) => `UREAD8U [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD16_S]: (instr: OpType.I32_LOAD16_S) => `UREAD16S [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_LOAD16_U]: (instr: OpType.I32_LOAD16_U) => `UREAD16U [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_STORE]: (instr: OpType.I32_STORE) => `UWRITE32 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I64_STORE]: (instr: OpType.I64_STORE) => `UWRITE64 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_STORE8]: (instr: OpType.I32_STORE8) => `UWRITE8 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_STORE16]: (instr: OpType.I32_STORE16) => `UWRITE16 [MAB1] + [POP] + ${instr.offset}`,
    [OP.I32_EQZ]: 'NOT',
    [OP.I32_EQ]: 'EQ',
    [OP.I32_LT_S]: 'SLT',
    [OP.I32_LT_U]: 'ULT',
