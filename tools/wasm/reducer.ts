...
import { instrId, NumberType, RefType, ValueType, valueTypeWords, VectorType, WasmBlock, WasmBranchDir, WasmFunction, WasmFunctionKind, WasmInstr, WasmInstrFunc, WasmModule } from "./wasmModule";
...
export class Reducer {
    ...
    private forwardTargets: Set<WasmBlock> = new Set();
    ...
    private reduceBlockBody(func: WasmFunction, body: WasmInstr[]) {
    ...
    private createTriWasmLibCall(base: WasmInstr, name: string): WasmInstrFunc { // TODO: Add instruction that calls a triwasmlib function with specified type, useful for call_indirect, where parameters and results may be different
        ...
        return { id: instrId(base), opcode: OP.CALL, func };
    }
    ...
    private reduceBlock(func: WasmFunction, block: WasmBlock): boolean {
        ...
        this.reduceBlockBody(func, block.body);
        this.blockStack.pop();
        this.typeStack = exitStack;
        let nextUnreachable = !this.forwardTargets.has(block);
        if (!nextUnreachable) {
            this.forwardTargets.delete(block);
        }
    ...
    private reduceInstr(func: WasmFunction, newBody: WasmInstr[], instr: WasmInstr): boolean {
        ...
        switch (instr.opcode) {
            ...
            case OP.UNREACHABLE: {
                newBody.push(this.createTriWasmLibCall(instr, 'unreachable'));
                unreachable = true;
                break;
            }
            case OP.BLOCK: {
                unreachable = this.reduceBlock(func, instr.block);
                newBody.push(instr);
                break;
            }
            case OP.LOOP: {
            ...
            case OP.IF: {
                ...
                let nextUnreachable = this.reduceBlock(func, instr.block);
                newBody.push(instr);
                unreachable = nextUnreachable && instr.withElse;
                break;
            }
            case OP.ELSE: {
                this.typeStack = [...(this.blockStack.at(-1)!.type.params || [])];
                if (!instr.unreachable) {
                    let target = this.blockStack.at(-1) as WasmBlock;
                    newBody.push({ id: instrId(instr), opcode: OP.BR, target, direction: WasmBranchDir.Forward });
                    this.forwardTargets.add(target);
                    instr.unreachable = true; // TODO: After reduction it will be always unreachable, is this property needed?
                }
                newBody.push(instr);
                break;
            }
            ...
            case OP.BR: {
                ...
                if (instr.direction == WasmBranchDir.Forward) {
                    this.forwardTargets.add(instr.target);
                }
                unreachable = true;
                newBody.push(instr);
                break;
            ...
            case OP.CALL_INDIRECT: {
                ...
                if (this.module.tables.length > 1) { // TODO: Compare only count of non-deleted tables
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'call_indirect_table'));
                } else {
                    newBody.push(this.createTriWasmLibCall(instr, 'call_indirect'));
                }
                break;
            }
            case OP.DROP: {
            ...
            case OP.SELECT_T: {
                ...
                this.pushTypes(type);
                newBody.push(this.createTriWasmLibCall(instr, 'select' + (32 * valueTypeWords(type))));
                break;
            }
            case OP.LOCAL_GET: {
                let type: ValueType;
            ...
            case OP.I64_LOAD: { // Generated from expression: {#mem64} ## {elif ..offset == 0} @i64_load_0 {else} i32.const value:..offset ; @i64_load
                if (this.ext.mem64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_load_0'));
                } else {
                    newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_load'));
                }
                this.popTypes(NumberType.I32);
            ...
            case OP.I64_LOAD8_S: { // Generated from expression: i32.load8_s offset, memory {#i64} i64.extend_i32_s {else} @i64_extend_i32_s
                ...
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_extend_i32_s'));
                }
                this.popTypes(NumberType.I32);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_STORE: { // Generated from expression: {#mem64} ## {elif ..offset == 0} @i64_store_0 {else} i32.const value:..offset ; @i64_store {end}
                if (this.ext.mem64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_store_0'));
                } else {
                    newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_store'));
                }
            ...
            case OP.MEMORY_SIZE: { // Generated from expression: @memory_size
                newBody.push(this.createTriWasmLibCall(instr, 'memory_size'));
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.MEMORY_GROW: { // Generated from expression: @memory_grow
                newBody.push(this.createTriWasmLibCall(instr, 'memory_grow'));
                this.popTypes(NumberType.I32);
                this.pushTypes(NumberType.I32);
                break;
            }
            ...
            case OP.I64_EQ: { // Generated from expression: {#i64} ## {else} @i64_eq
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_eq'));
                }
            ...
            case OP.I32_CLZ: { // Generated from expression: @i32_clz
                newBody.push(this.createTriWasmLibCall(instr, 'i32_clz'));
                this.popTypes(NumberType.I32);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I32_CTZ: { // Generated from expression: @i32_ctz
                newBody.push(this.createTriWasmLibCall(instr, 'i32_ctz'));
                this.popTypes(NumberType.I32);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I32_POPCNT: { // Generated from expression: @i32_popcnt
                newBody.push(this.createTriWasmLibCall(instr, 'i32_popcnt'));
                this.popTypes(NumberType.I32);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I32_ROTL: { // Generated from expression: @i32_rotl
                newBody.push(this.createTriWasmLibCall(instr, 'i32_rotl'));
                this.popTypes(NumberType.I32, NumberType.I32);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I32_ROTR: { // Generated from expression: @i32_rotr
                newBody.push(this.createTriWasmLibCall(instr, 'i32_rotr'));
                this.popTypes(NumberType.I32, NumberType.I32);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I64_CLZ: { // Generated from expression: @i64_clz32; i32.const value:0
                newBody.push(this.createTriWasmLibCall(instr, 'i64_clz32'));
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: 0 });
                this.popTypes(NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_CTZ: { // Generated from expression: @i64_ctz32; i32.const value:0
                newBody.push(this.createTriWasmLibCall(instr, 'i64_ctz32'));
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: 0 });
                this.popTypes(NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_POPCNT: { // Generated from expression: @i64_popcnt32; i32.const value:0
                newBody.push(this.createTriWasmLibCall(instr, 'i64_popcnt32'));
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: 0 });
                this.popTypes(NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_ADD: { // Generated from expression: {#i64} ## {else} @i64_add
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_add'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_SUB: { // Generated from expression: {#i64} ## {else} @i64_sub
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_sub'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_MUL: { // Generated from expression: {#i64} ## {else} @i64_mul
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_mul'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_DIV_S: { // Generated from expression: {#i64} ## {else} @i64_div_s
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_div_s'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_DIV_U: { // Generated from expression: {#i64} ## {else} @i64_div_u
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_div_u'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_REM_S: { // Generated from expression: {#i64} ## {else} @i64_rem_s
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_rem_s'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_REM_U: { // Generated from expression: {#i64} ## {else} @i64_rem_u
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_rem_u'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_AND: { // Generated from expression: {#i64} ## {else} @i64_and
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_and'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_OR: { // Generated from expression: {#i64} ## {else} @i64_or
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_or'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_XOR: { // Generated from expression: {#i64} ## {else} @i64_xor
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_xor'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.I64_SHL: { // Generated from expression: {#i64} ## {else} @i64_shl
                if (this.ext.i64) {
                    ...
                    newBody.push(this.createTriWasmLibCall(instr, 'i64_shl'));
                }
                this.popTypes(NumberType.I64, NumberType.I64);
                this.pushTypes(NumberType.I64);
                break;
            ...
            case OP.TABLE_COPY: { // Generated from expression: i32.const value:..tables[0].index ; i32.const value:..tables[1].index ; @table_copy
                ...
                newBody.push(this.createTriWasmLibCall(instr, 'table_copy'));
                this.popTypes(NumberType.I32, NumberType.I32, NumberType.I32);
                break;
            }
            case OP.TABLE_SIZE: { // Generated from expression: i32.const value:..table.index ; @table_size
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.table.index });
                newBody.push(this.createTriWasmLibCall(instr, 'table_size'));
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.V128_LOAD: { // Generated from expression: i32.const value:..offset ; @v128_load
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load'));
                this.popTypes(NumberType.I32);
            ...
            case OP.V128_LOAD8X8_S: { // Generated from expression: i32.const value:..offset ; @v128_load8x8_s
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load8x8_s'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD8X8_U: { // Generated from expression: i32.const value:..offset ; @v128_load8x8_u
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load8x8_u'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD16X4_S: { // Generated from expression: i32.const value:..offset ; @v128_load16x4_s
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load16x4_s'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD16X4_U: { // Generated from expression: i32.const value:..offset ; @v128_load16x4_u
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load16x4_u'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD32X2_S: { // Generated from expression: i32.const value:..offset ; @v128_load32x2_s
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load32x2_s'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD32X2_U: { // Generated from expression: i32.const value:..offset ; @v128_load32x2_u
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load32x2_u'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD8_SPLAT: { // Generated from expression: i32.const value:..offset ; @v128_load8_splat
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load8_splat'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD16_SPLAT: { // Generated from expression: i32.const value:..offset ; @v128_load16_splat
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load16_splat'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD32_SPLAT: { // Generated from expression: i32.const value:..offset ; @v128_load32_splat
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load32_splat'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD64_SPLAT: { // Generated from expression: i32.const value:..offset ; @v128_load64_splat
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load64_splat'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_STORE: { // Generated from expression: i32.const value:..offset ; @v128_store
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_store'));
            ...
            case OP.V128_CONST: { // Generated from expression: i32.const value:this.bytesToI32(..value\, 0) ; i32.const value:this.bytesToI32(..value\, 4) ; i32.const value:this.bytesToI32(..value\, 8) ; i32.const value:this.bytesToI32(..value\, 12)
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: this.bytesToI32(instr.value, 0) });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: this.bytesToI32(instr.value, 4) });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: this.bytesToI32(instr.value, 8) });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: this.bytesToI32(instr.value, 12) });
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_SHUFFLE: { // Generated from expression: i32.const value:this.bytesToI32(..value\, 0) ; i32.const value:this.bytesToI32(..value\, 4) ; i32.const value:this.bytesToI32(..value\, 8) ; i32.const value:this.bytesToI32(..value\, 12) ; @i8x16_shuffle
                ...
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: this.bytesToI32(instr.value, 8) });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: this.bytesToI32(instr.value, 12) });
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_shuffle'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_SWIZZLE: { // Generated from expression: @i8x16_swizzle
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_swizzle'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_SPLAT: { // Generated from expression: @i8x16_splat
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_splat'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_SPLAT: { // Generated from expression: @i16x8_splat
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_splat'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_SPLAT: { // Generated from expression: @i32x4_splat
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_splat'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I64X2_SPLAT: { // Generated from expression: @i64x2_splat
                newBody.push(this.createTriWasmLibCall(instr, 'i64x2_splat'));
                this.popTypes(NumberType.I64);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F32X4_SPLAT: { // Generated from expression: @f32x4_splat
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_splat'));
                this.popTypes(NumberType.F32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F64X2_SPLAT: { // Generated from expression: @f64x2_splat
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_splat'));
                this.popTypes(NumberType.F64);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_EXTRACT_LANE_S: { // Generated from expression: i32.const value:..index ; @i8x16_extract_lane_s
                ...
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_extract_lane_s'));
            ...
            case OP.I8X16_EXTRACT_LANE_U: { // Generated from expression: i32.const value:..index ; @i8x16_extract_lane_u
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_extract_lane_u'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I8X16_REPLACE_LANE: { // Generated from expression: i32.const value:..index ; @i8x16_replace_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_replace_lane'));
            ...
            case OP.I16X8_EXTRACT_LANE_S: { // Generated from expression: i32.const value:..index ; @i16x8_extract_lane_s
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_extract_lane_s'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I16X8_EXTRACT_LANE_U: { // Generated from expression: i32.const value:..index ; @i16x8_extract_lane_u
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_extract_lane_u'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I16X8_REPLACE_LANE: { // Generated from expression: i32.const value:..index ; @i16x8_replace_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_replace_lane'));
                this.popTypes(VectorType.V128, NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_EXTRACT_LANE: { // Generated from expression: i32.const value:..index ; @i32x4_extract_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_extract_lane'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.I32X4_REPLACE_LANE: { // Generated from expression: i32.const value:..index ; @i32x4_replace_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_replace_lane'));
                this.popTypes(VectorType.V128, NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I64X2_EXTRACT_LANE: { // Generated from expression: i32.const value:..index ; @i64x2_extract_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i64x2_extract_lane'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.I64);
                break;
            }
            case OP.I64X2_REPLACE_LANE: { // Generated from expression: i32.const value:..index ; @i64x2_replace_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'i64x2_replace_lane'));
            ...
            case OP.F32X4_EXTRACT_LANE: { // Generated from expression: i32.const value:..index ; @f32x4_extract_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_extract_lane'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.F32);
                break;
            }
            case OP.F32X4_REPLACE_LANE: { // Generated from expression: i32.const value:..index ; @f32x4_replace_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_replace_lane'));
            ...
            case OP.F64X2_EXTRACT_LANE: { // Generated from expression: i32.const value:..index ; @f64x2_extract_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_extract_lane'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.F64);
                break;
            }
            case OP.F64X2_REPLACE_LANE: { // Generated from expression: i32.const value:..index ; @f64x2_replace_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_replace_lane'));
                this.popTypes(VectorType.V128, NumberType.F64);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_EQ: { // Generated from expression: @i8x16_eq
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_eq'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_NE: { // Generated from expression: @i8x16_ne
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_ne'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_LT_S: { // Generated from expression: @i8x16_lt_s
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_lt_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_LT_U: { // Generated from expression: @i8x16_lt_u
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_lt_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_GT_S: { // Generated from expression: @i8x16_gt_s
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_gt_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_GT_U: { // Generated from expression: @i8x16_gt_u
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_gt_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_LE_S: { // Generated from expression: @i8x16_le_s
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_le_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_LE_U: { // Generated from expression: @i8x16_le_u
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_le_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_GE_S: { // Generated from expression: @i8x16_ge_s
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_ge_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I8X16_GE_U: { // Generated from expression: @i8x16_ge_u
                newBody.push(this.createTriWasmLibCall(instr, 'i8x16_ge_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_EQ: { // Generated from expression: @i16x8_eq
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_eq'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_NE: { // Generated from expression: @i16x8_ne
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_ne'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_LT_S: { // Generated from expression: @i16x8_lt_s
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_lt_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_LT_U: { // Generated from expression: @i16x8_lt_u
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_lt_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_GT_S: { // Generated from expression: @i16x8_gt_s
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_gt_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_GT_U: { // Generated from expression: @i16x8_gt_u
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_gt_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_LE_S: { // Generated from expression: @i16x8_le_s
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_le_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_LE_U: { // Generated from expression: @i16x8_le_u
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_le_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_GE_S: { // Generated from expression: @i16x8_ge_s
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_ge_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I16X8_GE_U: { // Generated from expression: @i16x8_ge_u
                newBody.push(this.createTriWasmLibCall(instr, 'i16x8_ge_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_EQ: { // Generated from expression: @i32x4_eq
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_eq'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_NE: { // Generated from expression: @i32x4_ne
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_ne'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_LT_S: { // Generated from expression: @i32x4_lt_s
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_lt_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_LT_U: { // Generated from expression: @i32x4_lt_u
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_lt_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_GT_S: { // Generated from expression: @i32x4_gt_s
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_gt_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_GT_U: { // Generated from expression: @i32x4_gt_u
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_gt_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_LE_S: { // Generated from expression: @i32x4_le_s
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_le_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_LE_U: { // Generated from expression: @i32x4_le_u
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_le_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_GE_S: { // Generated from expression: @i32x4_ge_s
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_ge_s'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.I32X4_GE_U: { // Generated from expression: @i32x4_ge_u
                newBody.push(this.createTriWasmLibCall(instr, 'i32x4_ge_u'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F32X4_EQ: { // Generated from expression: @f32x4_eq
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_eq'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F32X4_NE: { // Generated from expression: @f32x4_ne
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_ne'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F32X4_LT: { // Generated from expression: @f32x4_lt
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_lt'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F32X4_GT: { // Generated from expression: @f32x4_gt
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_gt'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F32X4_LE: { // Generated from expression: @f32x4_le
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_le'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F32X4_GE: { // Generated from expression: @f32x4_ge
                newBody.push(this.createTriWasmLibCall(instr, 'f32x4_ge'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F64X2_EQ: { // Generated from expression: @f64x2_eq
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_eq'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F64X2_NE: { // Generated from expression: @f64x2_ne
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_ne'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F64X2_LT: { // Generated from expression: @f64x2_lt
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_lt'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F64X2_GT: { // Generated from expression: @f64x2_gt
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_gt'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F64X2_LE: { // Generated from expression: @f64x2_le
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_le'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.F64X2_GE: { // Generated from expression: @f64x2_ge
                newBody.push(this.createTriWasmLibCall(instr, 'f64x2_ge'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_NOT: { // Generated from expression: @v128_not
                newBody.push(this.createTriWasmLibCall(instr, 'v128_not'));
                this.popTypes(VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_AND: { // Generated from expression: @v128_and
                newBody.push(this.createTriWasmLibCall(instr, 'v128_and'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_ANDNOT: { // Generated from expression: @v128_andnot
                newBody.push(this.createTriWasmLibCall(instr, 'v128_andnot'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_OR: { // Generated from expression: @v128_or
                newBody.push(this.createTriWasmLibCall(instr, 'v128_or'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_XOR: { // Generated from expression: @v128_xor
                newBody.push(this.createTriWasmLibCall(instr, 'v128_xor'));
                this.popTypes(VectorType.V128, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_BITSELECT: { // Generated from expression: @v128_bitselect
                newBody.push(this.createTriWasmLibCall(instr, 'v128_bitselect'));
            ...
            case OP.V128_ANY_TRUE: { // Generated from expression: @v128_any_true
                newBody.push(this.createTriWasmLibCall(instr, 'v128_any_true'));
                this.popTypes(VectorType.V128);
                this.pushTypes(NumberType.I32);
                break;
            }
            case OP.V128_LOAD8_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_load8_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load8_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD16_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_load16_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load16_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD32_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_load32_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load32_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD64_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_load64_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load64_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_STORE8_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_store8_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_store8_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_STORE16_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_store16_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_store16_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_STORE32_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_store32_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_store32_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_STORE64_LANE: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_store64_lane
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_store64_lane'));
                this.popTypes(NumberType.I32, VectorType.V128);
                this.pushTypes(VectorType.V128);
                break;
            }
            case OP.V128_LOAD32_ZERO: { // Generated from expression: i32.const value:..offset ; i32.const value:..index ; @v128_load32_zero
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.offset });
                newBody.push({ id: instrId(instr), opcode: OP.I32_CONST, value: instr.index });
                newBody.push(this.createTriWasmLibCall(instr, 'v128_load32_zero'));
                this.popTypes(NumberType.I32);
                this.pushTypes(VectorType.V128);
                break;
            }
